...
s = time.time()
a1 = NewtonSystems(func, H, gradient1, [-1, 20], 100000, 1e-4)
e = time.time()
hr1 = e-s
s = time.time()
a2 = BFGS(func, H, gradient1, [-1, 20], 100000, 1e-4)
e = time.time()
hr2 = e-s
s = time.time()
a3 = SR1(func, H, gradient1, [-1, 20], 100000, 1e-4)
e = time.time()
hr3 = e-s
it1 = a1[1]
it2 = a2[1]
...
print("newtons results", a1[0])
print("BFGS results", a1[0])
...
print("Newtons Method", it1, "iterations,", hr1, "seconds",  hr1/it1, "seconds per iteration")
